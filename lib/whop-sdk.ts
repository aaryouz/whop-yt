...
// Use fallback values during build time when env vars might not be set
// These will be replaced at runtime with actual values from Vercel env vars
const appId = process.env.NEXT_PUBLIC_WHOP_APP_ID || "app_build_placeholder";
const appApiKey = process.env.WHOP_API_KEY || "build_placeholder_key";
